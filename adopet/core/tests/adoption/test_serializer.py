...
from adopet.core.serializers import AdoptionSerializer
...
def test_negativel_create_error_in_change_pet_adopted_info(mocker, create_adoption_payload):
    ...
    mocker.patch("adopet.core.serializers.AdoptionSerializer._change_to_adopted", new=lambda x, y: raise_())
